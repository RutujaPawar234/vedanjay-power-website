        ...
        <div className="row align-items-center g-5">
          ...
          <div className="col-lg-6 reveal-right">
            <div className={`ops-monitor ${imgOk ? 'has-img' : ''}`} role="img" aria-label="Continuous 24 by 7 renewable forecasting operations monitoring">
              {/* Supplied graphic (drop /images/home/ops-24x7.png) */}
              <img
              ...
              {/* Animated fallback (shown only if the graphic is missing) */}
              {!imgOk && (
                <>
                  ...
                  <svg className="ops-monitor__wave" viewBox="0 0 320 90" aria-hidden="true" focusable="false" preserveAspectRatio="none">
                    ...
                    <path id="opsWave2" className="ops-wave__line ops-wave__line--2" d="M0 70 Q 40 45 80 65 T 160 60 T 240 58 T 320 62" fill="none" stroke="var(--vp-gold-400)" strokeWidth="2" opacity="0.8" />
                    ...
                    <circle r="3" fill="var(--vp-gold-500)">
